        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto">
              At Lindo Care, we care about your baby’s comfort — and your
              satisfaction. If something isn’t right with your diaper order,
              we’re here to help.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Request a full refund within 7 days of receiving your diaper
                order
              </p>
            </div>
            <div className="text-center">
              <RefreshCw className="w-12 h-12 mx-auto mb-4 text-blue-700" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                30-Day Exchanges
              </h3>
              <p className="text-gray-600">
                Free exchanges or store credit within 30 days for size changes
              </p>
            </div>
            <div className="text-center">
              <Package className="w-12 h-12 mx-auto mb-4 text-blue-700" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                Easy Returns
              </h3>
              <p className="text-gray-600">
                Unopened, unused diapers in original packaging are eligible
              </p>
            </div>
          </div>
        </div>
                ...
                <div>
                  ...
                  <ul className="text-gray-700 space-y-2 list-disc pl-6">
                    <li>
                      ...
                      <span className="font-semibold">7 days</span> of
                      receiving your diaper order.
                    </li>
                    <li>
                      Free exchanges or store credit for size changes within{" "}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              <p className="text-gray-700 mb-4">
                If you receive damaged, defective, or incorrect diaper
                products, contact us within{" "}
                <span className="font-semibold">48 hours</span> of delivery.
              </p>
              <div className="mb-2">
                <span className="font-semibold">Email:</span>{" "}
                <a
                  href="mailto:hello@lindocare.com"
              ...
              <p className="text-gray-700">
                We’ll resolve it with a refund, replacement, or store credit —
            ...
            <div className="bg-gray-50 rounded-xl p-8 shadow-lg">
              <ul className="text-gray-700 space-y-2 list-disc pl-6">
                ...
                <ul className="pl-8 list-disc">
                  ...
                  <li>
                    Funds are returned via your original payment method or
                    Mobile Money
                  </li>
                </ul>
              </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white bg-opacity-90 rounded-xl p-6">
              <Mail className="w-12 h-12 mx-auto mb-4 text-blue-700" />
              <h3 className="text-xl font-bold mb-2 text-blue-900">Email Us</h3>
              <a
                href="mailto:hello@lindocare.com"
                className="text-blue-800 font-bold hover:underline text-lg"
              >
                hello@lindocare.com
              </a>
            </div>
            <div className="bg-white bg-opacity-90 rounded-xl p-6">
              <Phone className="w-12 h-12 mx-auto mb-4 text-blue-700" />
              <h3 className="text-xl font-bold mb-2 text-blue-900">Call Us</h3>
              <a
                href="tel:+250795575622"
                className="text-blue-800 font-bold hover:underline text-lg"
              >
                +250 795 575 622
              </a>
            ...
            <div className="bg-white bg-opacity-90 rounded-xl p-6">
              <MapPin className="w-12 h-12 mx-auto mb-4 text-blue-700" />
      ...
      <section className="py-8 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-lg text-gray-800 font-semibold">
            Thank you for choosing Lindo Care.
            <br />
