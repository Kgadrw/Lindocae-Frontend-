            ...
            <section ref={settingsRef} id="settings" className="bg-white rounded-2xl shadow p-4 border border-yellow-100 flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center">
                <div className="flex flex-col items-center gap-1">
                  <Image src={avatar || "/lindo.png"} alt="avatar" className="w-14 h-14 rounded-full object-cover border-2 border-yellow-400" width={56} height={56} style={{ width: 'auto', height: 'auto' }} />
